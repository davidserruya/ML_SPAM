...
st.markdown(
"""
En apprentissage non-supervisé, un algorithme reçoit un ensemble de données non-étiquetées sur lequel il va pouvoir s’entraîner et identifier des similaités afin de réaliser des regroupements.
